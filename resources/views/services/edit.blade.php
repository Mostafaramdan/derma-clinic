...
@section('title', __('messages.services.edit_title'))
@section('content')
<div class="container pt-4 d-flex flex-column align-items-center" style="min-height:70vh;">
    <div class="w-100" style="max-width: 900px;">
        <div class="text-center mb-4">
            ...
            <h2 class="fw-bold text-primary">{{ __('messages.services.edit_title') }}</h2>
        </div>
        <div class="bg-white shadow-sm rounded-4 p-4 border border-2">
            ...
            <form action="{{ route('services.update', $service) }}" method="POST">
                ...
                <div class="d-flex gap-2 justify-content-center mt-4">
                    <button type="submit" class="btn btn-primary px-4 fw-bold"><i class="bi bi-check-circle me-1"></i> {{ __('messages.services.update') }}</button>
