...
@section('title', __('messages.admins.edit_title'))
@section('content')
...
<div class="container py-4 d-flex flex-column align-items-center" style="min-height:70vh;">
  ...
  <h2 class="fw-bold text-primary">{{ __('messages.admins.edit_title') }}</h2>
    </div>
    <div class="bg-white shadow rounded-4 p-4 border border-2">
      <form method="POST" action="{{ route('admin.admins.update', $admin) }}">
        ...
        <div class="mb-3">
          <label for="password" class="form-label fw-bold">{{ __('messages.admins.password_hint') }}</label>
        ...
        <div class="d-flex gap-2 justify-content-center mt-4">
          <button type="submit" class="btn btn-primary px-4 fw-bold"><i class="bi bi-check-circle me-1"></i> {{ __('messages.admins.update') }}</button>
